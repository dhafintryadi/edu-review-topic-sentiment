...
# Adjusted relative paths since script resides in core/training/
ROOT       = Path(__file__).resolve().parent.parent.parent
PHASE1_DIR = ROOT / "Topic-Modelling" / "phase1_outputs"
PHASE2_DIR = ROOT / "Topic-Modelling" / "phase2_outputs"
...
print("=" * 70)
print("  PHASE 3B — Final LDA Topic Extraction (Auditable Training script)")
print("=" * 70)
...
if __name__ == "__main__":
    ...
    # Select k based on composite score
    ...
    OPTIMAL_K = 8  # <-- Phase 3A Analysis: k=8 recommended
